...
复杂推理和综述是图真正做得好的地方。同一基准里，图家族在复杂推理上大胜（HippoRAG2 53.38 对 Basic RAG 42.93），上下文综述高 12.8 分。两个常见的误读要当心：这些数字的对比对象是 HippoRAG2，不是微软的 GraphRAG；图在简单任务上输的幅度（0.78 分）远小于复杂任务上赢的幅度。
